...
- `src/App.jsx`: interfaz principal, acceso, arbol, perfiles, ramas, galeria y linea de tiempo.
...
- No existe todavia carga real de fotos/documentos desde la interfaz.
- No existe panel administrativo para editar familiares.
...
3. Agregar subida de imagenes con Supabase Storage o Cloudinary.
4. Crear formulario para agregar familiares.
5. Crear editor de historias y anecdotas.
